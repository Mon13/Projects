...
function appendComposer(productname,productid) {	
    var row;
    var cell;
    var linkElement;
    ...
    linkElement.setAttribute("href", "ProductListing?action=lookup&id=" + productid);
    ...
    if (responseXML == null) {
        ...
        if (composers.childNodes.length > 0) {
            ...
            for (loop = 0; loop < composers.childNodes.length; loop++) {
                ...
                var id = composer.getElementsByTagName("id")[0];
