...
public class Sorted_LinkedList<T> implements ListInterface<T>{
	...
	int current_pointer ;
	public Comparator<String> string_Comp = new Comparator<String>() {

		public int compare(String string1, String string2){
			return string1.compareTo(string2);}};

			public Sorted_LinkedList(int size)
