...
<% } else { %>
   ...
   <% } %>
    ...
    <div id="body">
        ...
        <article>
        <h3>List of All Books Borrowed</h3>
        
        <%
			UserDAO dataobject1= new UserDAO();
		
			List<BookList> result=dataobject1.getStudentsFined();
			String htmlpage="\n";
            ...
            {
                    htmlpage+= "<h4>";
                 	htmlpage+=result.get(i).getBook().getBookTitle()+"  "; //CHECK THIS THREE DIFFERENT BEAN 
                    htmlpage+= "</h4><br>";
